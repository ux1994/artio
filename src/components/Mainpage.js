        ...
        <div className="bodybg">
                ...
                <div className="row homenavbg">
                    ...
                    <div className="col-lg-4 homenav mobile">
                        <ul>
                            ...
                            <li> <Link to="/dashboard"><a href="dashboard.html" className="btnn" >Enter App</a></Link></li>
                        </ul>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-lg-7">
                                ...
                                <div className="bannerbuttons">
                                    <div className="mt-33">
                                    <Link to="/dashboard"> <a href="dashboard.html" className="bannerbtnn">Enter App</a></Link></div>
                                    <div className="mt-33 mr-20">
                                    <Link to="/dashboard"> <a href="dashboard.html" className="leranbtun mt-5">Learn More</a></Link></div>
                                </div>
                            </div>
            ...
            <div className="rightvector">
                <div className="container stakethree">
                    ...
                    <Link to="/dashboard"> <a href="dashboard.html" className="bannerbtnn">Enter App</a></Link>
                    </div>
                </div>
